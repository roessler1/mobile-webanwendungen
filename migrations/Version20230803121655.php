 ...
 */
final class Version20230803121655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER last_artists TYPE TEXT');
        $this->addSql('ALTER TABLE users ALTER last_artists SET NOT NULL');
        $this->addSql('ALTER TABLE users ALTER last_albums TYPE TEXT');
        $this->addSql('ALTER TABLE users ALTER last_albums SET NOT NULL');
        $this->addSql('COMMENT ON COLUMN users.last_artists IS \'(DC2Type:simple_array)\'');
        $this->addSql('COMMENT ON COLUMN users.last_albums IS \'(DC2Type:simple_array)\'');
    }
