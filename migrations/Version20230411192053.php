 ...
 */
final class Version20230411192053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE album (id INT NOT NULL, artist_id INT NOT NULL, name VARCHAR(255) NOT NULL, cover_directory VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE song (id INT NOT NULL, album_id INT NOT NULL, name VARCHAR(255) NOT NULL, duration INT NOT NULL, directory VARCHAR(255) NOT NULL, cover_directory VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
